...
import { AuthInfo } from 'src/app/security/Authorization';
...
@Injectable({
  ...
  export class LocalStorageService {
    ...
    public setBasicAuthority() {
      ...
      this.getAuthInfo().authorities.forEach(permission => applicationPermission.push(ApplicationPermission[permission.authority as keyof typeof ApplicationPermission]))
      localStorage.setItem('authorities', JSON.stringify(applicationPermission));
    }
  
    public getAuthorities(): ApplicationPermission[] | null {
